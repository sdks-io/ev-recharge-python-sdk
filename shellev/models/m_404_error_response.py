...
class M404ErrorResponse(object):

    """Implementation of the '404ErrorResponse' model.
    ...
    Attributes:
        ...
        errors (List[M404ErrorResponseError]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the M404ErrorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [M404ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
