...
class UnauthorizedErrMsg(object):
    ...
    Attributes:
        ...
        description (str): Technical details of the error message, the example which
            is given in the sample payload is one of the scenarios. actual response
            will vary based on the technical nature
