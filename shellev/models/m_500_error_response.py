...
class M500ErrorResponse(object):

    """Implementation of the '500ErrorResponse' model.
    ...
    Attributes:
        ...
        errors (List[M500ErrorResponseError]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the M500ErrorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [M500ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
