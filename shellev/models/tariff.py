...
class Tariff(object):
    ...
    Attributes:
        ...
        updated (str): ISO8601-compliant UTC datetime of the last update of the Tariff
        updated_by (TariffVOUpdatedByEnum): Source of the last update of the tariff
            details
        structure (str): Tariff structure that this tariff belongs to, typically
            Default unless specific tariff is defined for provider
    ...
    def from_dictionary(cls,
        ...
        start_fee =\
            ...
            if dictionary.get("startFee")\
                else APIHelper.SKIP
        per_minute =\
            dictionary.get("perMinute")\
            if dictionary.get("perMinute")\
                else APIHelper.SKIP
        per_k_wh =\
            dictionary.get("perKWh")\
            if dictionary.get("perKWh")\
                else APIHelper.SKIP
        currency =\
        ...
        updated_by =\
            ...
            if dictionary.get("updatedBy")\
                else APIHelper.SKIP
        structure =\
            dictionary.get("structure")\
            if dictionary.get("structure")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _start_fee=(
            self.start_fee
            if hasattr(self, "start_fee")
            else None
        )
        _per_minute=(
            self.per_minute
            if hasattr(self, "per_minute")
            else None
        )
        _per_k_wh=(
            self.per_k_wh
            if hasattr(self, "per_k_wh")
            else None
        )
        _currency=(
            self.currency
        ...
        return (
            ...
            f"start_fee={_start_fee!r}, "
            f"per_minute={_per_minute!r}, "
            f"per_k_wh={_per_k_wh!r}, "
            f"currency={_currency!r}, "
            f"updated={_updated!r}, "
            f"updated_by={_updated_by!r}, "
            f"structure={_structure!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"start_fee={_start_fee!s}, "
            f"per_minute={_per_minute!s}, "
            f"per_k_wh={_per_k_wh!s}, "
            f"currency={_currency!s}, "
            f"updated={_updated!s}, "
            f"updated_by={_updated_by!s}, "
            f"structure={_structure!s}, "
            f")"
        )
