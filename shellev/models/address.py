...
class Address(object):
    ...
    Attributes:
        street_and_number (str): Street Name and Number of the Shell Recharge Location
        postal_code (str): Postal Code of the Shell Recharge Location
        city (str): City name of the Shell Recharge Location
        country (str): ISO 3166 Alpha-2 Country Code of the Shell Recharge Location
    ...
    def from_dictionary(cls,
        ...
        street_and_number =\
            ...
            if dictionary.get("streetAndNumber")\
                else APIHelper.SKIP
        postal_code =\
    ...
    def __repr__(self):
        ...
        _street_and_number=(
            ...
            if hasattr(self, "street_and_number")
            else None
        )
        _postal_code=(
            self.postal_code
        ...
        return (
            ...
            f"street_and_number={_street_and_number!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"street_and_number={_street_and_number!s}, "
