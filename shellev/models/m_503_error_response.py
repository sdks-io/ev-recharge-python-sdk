...
class M503ErrorResponse(object):

    """Implementation of the '503ErrorResponse' model.
    ...
    Attributes:
        ...
        errors (List[M503ErrorResponseError]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the M503ErrorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [M503ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
