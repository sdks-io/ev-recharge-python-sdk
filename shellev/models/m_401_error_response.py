...
class M401ErrorResponse(object):

    """Implementation of the '401ErrorResponse' model.
    ...
    Attributes:
        ...
        errors (List[M401ErrorResponseError]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the M401ErrorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [M401ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
