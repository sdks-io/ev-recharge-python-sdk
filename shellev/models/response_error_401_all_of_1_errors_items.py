...
class ResponseError401AllOf1ErrorsItems(object):

    """Implementation of the 'responseError401AllOf1ErrorsItems' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ResponseError401AllOf1ErrorsItems class"""
