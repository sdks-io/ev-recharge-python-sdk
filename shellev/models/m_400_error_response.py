...
class M400ErrorResponse(object):

    """Implementation of the '400ErrorResponse' model.
    ...
    Attributes:
        ...
        errors (List[M400ErrorResponseError]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the M400ErrorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [M400ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
