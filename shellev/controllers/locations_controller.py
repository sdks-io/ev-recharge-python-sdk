...
class LocationsController(BaseController):
    ...
    def get_locations_list(self,
        ...
        * Based on a specific charging unit ID (EVSE ID)
        ...
        Args:
            ...
            evse_status (GetLocationsListEvseStatusEnum, optional): Filter by
                Locations that have the given status
            connector_types (GetLocationsListConnectorTypesEnum, optional):
            ...
            authorization_methods (GetLocationsListAuthorizationMethodsEnum,
            ...
            per_page (int, optional): Restrict the number of sites in reposne
                per page.
            updated_since (str, optional): ZonedDateTime as string

        Returns:
            List[LocationResponeObject]: Response from the API. Paginated list
                of locations
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(LocationResponeObject.from_dictionary)
    ...
    def get_location_by_id(self,
        ...
        Returns:
            LocationResponeObject: Response from the API. Paginated list of
                locations
    ...
    def get_nearby_locations(self,
        ...
        This API provides the list of all near by Shell Recharge locations
        ...
        * Based on minimum Power output (in kW) available
        ...
        Args:
            ...
            operator_name (str, optional): Filter by Locations that have the
                given operator
            evse_status (GetNearbyLocationsEvseStatusEnum, optional): Filter
                by Locations that have the given status
            connector_types (GetNearbyLocationsConnectorTypesEnum, optional):
                Filter by Locations that have Connectors with these Connector
                Types
            connector_min_power (float, optional): Filter by Locations that
                have a Connector with at least this power output (in kW)
            authorization_methods (GetNearbyLocationsAuthorizationMethodsEnum,
                optional): Filter by Locations that support the given
                Authorization Methods
            with_operator_name (bool, optional): Return operator name in
        ...
        Returns:
            LocationResponeObject: Response from the API. Location
    ...
    def get_markers_list(self,
        ...
        Args:
            ...
            evse_status (GetMarkersListEvseStatusEnum, optional): Filter by
                Locations that have the given status
            connector_types (GetMarkersListConnectorTypesEnum, optional):
                Filter by Locations that have Connectors with the set of
                Connector Types
            connector_min_power (float, optional): Filter by Locations that
                have a Connector with at least this power output (in kW)
            authorization_methods (GetMarkersListAuthorizationMethodsEnum,
                optional): Filter by Locations that support the given
                Authorization Methods
            with_operator_name (bool, optional): Return operator name in
                marker object (only for marker type SingleChargePoint)
        ...
        Returns:
            List[SingleLocationMarker | MultiLocationMarker]: Response from
                the API. Array of Markers
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(lambda value: APIHelper.deserialize_union_type(
                 UnionTypeLookUp.get('MarkersResponse'), value))
            .local_error('400', 'The server cannot or will not process the request due to something that is perceived to be a client error (e.g., malformed request syntax, invalid request message framing, or deceptive request routing).', BadRequestException)
            .local_error('401', 'The request has not been applied because it lacks valid authentication credentials for the target resource.', UnauthorizedException)
            .local_error('404', 'Location Not Found', NotFoundException)
        ).execute()
