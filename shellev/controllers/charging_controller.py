...
from shellev.exceptions.v_2_charge_session_retrieve_404_error_exception import (
    V2ChargeSessionRetrieve404ErrorException,
)
from shellev.exceptions.v_2_charge_session_start_404_error_exception import (
    V2ChargeSessionStart404ErrorException,
)
from shellev.exceptions.v_2_charge_session_stop_404_error_exception import (
...
class ChargingController(BaseController):
    ...
    def start(self,
              request_id,
              body=None):
        """Perform a POST request to /v2/charge-session/start.
        ...
        Args:
            request_id (uuid|str): RequestId must be unique identifier value that can
                ...
                hyphens) <br>
            body (ChargesessionStartBody, optional): The request body parameter.
    ...
    def stop(self,
             request_id,
             session_id):
        """Perform a POST request to /v2/charge-session/stop.
    ...
    def get_charge_session_retrieve(self,
                                    request_id,
                                    session_id):
        """Perform a GET request to /v2/charge-session/retrieve.
        ...
        Returns:
            GetChargeSessionRetrieveResponse200Json: Response from the API. Success
    ...
    def active(self,
               request_id,
               ema_id):
        """Perform a GET request to /v2/charge-session/active.
