...
from shellev.models.multi_location_marker_v_2 import (
    MultiLocationMarkerV2,
)
from shellev.models.single_location_marker import (
    SingleLocationMarker,
)
from shellev.models.single_location_marker_v_2 import (
...
class UnionTypeLookUp:
    ...
    _templates: ClassVar[dict[str, Callable]] = {
        "LocationMarkerV2": lambda: OneOf(
            [
                LeafType(SingleLocationMarkerV2,
                         Context.create(
                             discriminator_value="SingleLocation",
                             discriminator="markerType",
                         )),
                LeafType(MultiLocationMarkerV2,
                         Context.create(
