...
class M429ErrorResponseError1Exception(shellev.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the M429ErrorResponseError1Exception class
        ...
        """
        super(M429ErrorResponseError1Exception, self).__init__(reason, response)
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get('Errors') is not None:
            self.errors = [M429ErrorResponseError.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            self.errors = None
